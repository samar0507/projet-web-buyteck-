      ...
      <div class="container-fluid py-1 px-3">
        <nav aria-label="breadcrumb">
          <ol class="breadcrumb bg-transparent mb-0 pb-0 pt-1 px-0 me-sm-6 me-5">
            ...
            <li class="breadcrumb-item text-sm text-dark active" aria-current="page">Detail Commandes</li>
          </ol>
          <h6 class="font-weight-bolder mb-0">Detail Commandes</h6>
        </nav>
        ...
        <div class="col-md-12 mt-4">
          <div class="card">
            <div class="card-header pb-0 px-3">
              <h6 class="mb-0">Detail Commandes </h6>
            </div>
  ...
  echo'
                <li class="list-group-item border-0 d-flex p-4 mb-2 bg-gray-100 border-radius-lg">
                  <div class="d-flex flex-column">
                    <h6 class="mb-3 text-sm">Product Name: '.$prod["nom"].'</h6>
                    <span class="mb-2 text-xs">Product Price: '.$prod["prix"].'</<span class="text-dark ms-sm-2 font-weight-bold"></span></span>
                    <span class="mb-2 text-xs">Quantity'.$row["qty"].'</ <span class="text-dark ms-sm-2 font-weight-bold"></span></span>
