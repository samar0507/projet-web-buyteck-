...
>>>>>>> 32b7c40b4d1e22d0e727c874fb2e37507b117f28
</head>
    ...
    <main class="main-content position-relative max-height-vh-100 h-100 mt-1 border-radius-lg ">
      ...
      <div class="container-fluid py-4">
       ...
       <div class="row">
          ...
          <form method="GET" action="rechercherListeProduits.php" >
            <h3 align="center" >Search products </h3>
        </br> <center>
    </br>    <div><h6>Write the name of product :</h6>                                
         <tr>
            <br><td align="center"><input  type="text" id="nom" name="nom" placeholder="the name of product.." ></td>
        </tr> <br> <br>
        <tr>
