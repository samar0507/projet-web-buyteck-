 ...
 <main class="main-content position-relative max-height-vh-100 h-100 mt-1 border-radius-lg ">
   ...
   <div class="container-fluid py-4">
    ...
    <div class="row">
       ...
       <form method="GET" action="rechercherListeCategorie.php" >
       
        <h3 align="center" >Search categories </h3>
            </br>
            </br>
    <center>
    <div><h6>Write the name of categories :</h6>
    </br>  </br>
        <input type="text1" id="nom_cat" name="nom_cat" placeholder="the name of categories..">
    </div>
        </br>
