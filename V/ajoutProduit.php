...
if (isset($_POST['nom']) and isset($_POST['int_cat']) and isset($_POST['description']) and isset($_POST['prix']) and isset($_POST['quantite']) and isset($_POST['disponibilite']) and isset($_POST['image']));
{if (!empty($_POST['nom']) and !empty($_POST['int_cat']) and !empty($_POST['description']) and !empty($_POST['prix']) and !empty($_POST['quantite']) and !empty($_POST['disponibilite']) and !empty($_POST['image']))
{
        ...
        <div class="col-12">
         ...
         <form action="" method="POST">
            ...
            <table border="1" align="center">
               <td align="center">Name of product</td>
               <td align="center"><input class="controle" type="text" placeholder="Enter Product Name.." name="nom" id="nom" required></td> 
               <tr align="center">
               <td>Categorie</td>
              ...
              foreach($listeCategories as $row){
                ...
                <td align="center">Description</td>
                 ...
                 <td align="center">Availablity</td>
                 <td align="center"><input  class="controle" type="text" placeholder="Enter Availablity.." name="disponibilite" id="disponibilite" required ></td>
                 </tr>
                 <tr align="center">
                 <td align="center">Upload picture</td>
                 <td align="center"> <input  type="file" name="image" id="image"  required></td>
                 </tr>
                 <tr align="center">
                 <td align="center"></td>
                 </tr>
                 <br><tr><td></td><td><input type="submit" onclick="verif()"; value="Submit" >                           
