...
$listeProduits=$ProduitsCore->triNom();
...
<body class="g-sidenav-show  bg-gray-100">
  <aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3 " id="sidenav-main">
    ...
    <div class="collapse navbar-collapse  w-auto  max-height-vh-100 h-100" id="sidenav-collapse-main">
      <ul class="navbar-nav">
        ...
        <li class="nav-item">
          <a class="nav-link  active" href="http://localhost//projet_web/web/back%20office/V/categories.php">
            <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
  ...
  <main class="main-content position-relative max-height-vh-100 h-100 mt-1 border-radius-lg ">
    ...
    <br>
     <br>
     <button onclick="location.href='http://localhost/projet_web/web/back%20office/V/ajoutProduit.php'">Add products </button>
     <button onclick="location.href='http://localhost/projet_web/web/back%20office/V/rechercherListeProduits.html'">Search products </button>
     <button onclick="location.href='http://localhost/projet_web/web/back%20office/V/imprimerProduits.php'">Print products</button>
     <button onclick="location.href='http://localhost/projet_web/web/back%20office/V/triPrix.php'">Sort products by price</button>
     <br>
     <br>
     <br>
     <br>
    ...
    <div class="topnav">
       <div class="search-container">
           <form action="rechercherprodAVANCER.php">
             <input type="text3"  id="char" name="char" placeholder="Search.." name="search" required >
...
<br><br><br>
           ...
           <th class="text-center text-uppercase text-secondary text-xxs font-weight-bolder opacity-7">Update</th>
                 ...
                 foreach($listeProduits as $row){
                   ...
                   <td align="center" class="zoom" ><img width="200"
