                    ...
                    <?php 
                                ...
                                foreach ($c as $row)
                                {
                                  ...
                                  $prod=$i->getProd($row["id_produit"]);
                                    ...
                                    <button><a href="../C/UpdateCartMinus.php?pId='.$prod["idprod"].'">-</a></button> 
                                    <input maxlength="12" class="input-text qty" title="Qty"  size="4" value="'.$row["qte"].'" name="">
                                    <button><a href="../C/UpdateCartPlus.php?pId='.$prod["idprod"].'">+</a></button> </td>

                                    <td><a class="button remove-item" href="../C/DeleteCart.php?pId='.$prod["idprod"].'"></a>
                                    </td>
                                    </tr>
                                ';
            ...
            <div class="col-sm-12">
              <div class="totals">
                ...
                <div class="inner">
                  <table class="table shopping-cart-table-total" id="shopping-cart-totals-table">
                    ...
                    <tfoot>
                      <tr>
                        ...
                        <td class="a-right"><strong><span class="price" >TND <?php  echo $DueAmount ?></span></strong></td>
                      </tr>
                    </tfoot>
                  ...
                  <ul class="checkout "  >
                    <li>
                      <button class="button btn-proceed-checkout" ><a  href="../C/AddCommande.php?id_client=1">Proceed to Checkout</a></button> 
                    </li>
