  ...
  if (
    ...
    $client = new client(
      ...
      // $_POST['dateb']
            ...
            $clientC->modifierclient($client, $_POST['username']);
...
<div id="error">
		...
		<?php
			if (isset($_POST['username'])){
				$client = $clientC->recupererclient($_POST['username']);
  ...
  <main class="main-content position-relative max-height-vh-100 h-100 mt-1 border-radius-lg ">
    ...
    <!-- End Navbar -->
    <div class="formu" style="text-align: -webkit-center; border: ridge; background-color: white;">
        <form onsubmit="verif()" method="post" name='f'>
          <p>
          <h3> My Account </h3>
          </p>
          <br>
          <fieldset>
            <table>
              ...
              <tr>
                <td> First Name : </td>
                <td> <input type="text" name="nom" id="nom" value="<?php echo $client['nom']; ?>">  </td>
              ...
              <tr>
                <td> Last Name : </td>
                <td> <input type="text" name="prenom" id="prenom" value="<?php echo $client['prenom']; ?>">
              </tr>
              </td>
              <tr>
                <tr>
                  <td> User Name : </td>
                  <td> <input type="text" name="username" id="username" value="<?php echo $client['username']; ?>">
                </tr>
                </td>
                <tr>
                <td> E-MAIL : </td>
                <td> <input type="text" name="email" id="email" value="<?php echo $client['email']; ?>"> </td>
              </tr>
  
  
              <tr>
                <td> Password : </td>
                <td> <input type="password" name="passwordd" id="passwordd" value="<?php echo $client['passwordd']; ?>"></td>
              </tr>
              ...
              <tr>
                <td> Phone Number </td>
                <td> <input type="text" name="noo" id="noo" value="<?php echo $client['noo']; ?>" ><span class="validity"></span> </td>
              </tr>
  
              <tr>
                <td> Date of birth </td>
                <td> <input type="date" name="date" min='01_10_2021' > </td>
              </tr>
          ...
          <div class="buttons-set">
            <button id="send2" name="" type="submit" class="button login" href='../login.html'><span>Submit</span></button>
            <button id="send2" name="" type="submit" class="button login"><span>Cancel</span></button>
