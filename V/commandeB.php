        ...
        <div class="col-md-12 mt-4">
          <div class="card">
            <div class="card-header pb-0 px-3">
              <h6 class="mb-0">Commandes  Information</h6>
            </div>
  ...
  echo'
                <li class="list-group-item border-0 d-flex p-4 mb-2 bg-gray-100 border-radius-lg">
                  <div class="d-flex flex-column">
                    <h6 class="mb-3 text-sm">Num commande: '.$row["num_commande"].'</h6>
                    <span class="mb-2 text-xs">Date commande: '.$row["date_commande"].'</span> <span class="text-dark font-weight-bold ms-sm-2"></span></span>
                    <span class="mb-2 text-xs">Status: '.$row["status"].'</<span class="text-dark ms-sm-2 font-weight-bold"></span></span>
                    <span class="mb-2 text-xs">Delivery type:'.$row["type_Livraison"].'</ <span class="text-dark ms-sm-2 font-weight-bold"></span></span>
                    <span class="mb-2 text-xs">Payment :'.$row["type_Paiment"].'</ <span class="text-dark ms-sm-2 font-weight-bold"></span></span>

                    </div>
                  <div class="ms-auto text-end">
                  <a class="btn btn-link text-dark px-3 mb-0" href="UpdateCommandeB.php?status=Confirmed&num='.$row["num_commande"].'"><i class="fas fa-pencil-alt text-dark me-2" aria-hidden="true"></i>Confirm</a>
                    <a class="btn btn-link text-danger text-gradient px-3 mb-0" href="UpdateCommandeB.php?status=Cancelled&num='.$row["num_commande"].'"><i class="far fa-trash-alt me-2"></i>Cancel </a>
                    <a class="button btn-link text-info" href="detailCommandeB.php?num_commande='.$row["num_commande"].'">View Details</a>
