...
<body class="g-sidenav-show  bg-gray-100">
  ...
  <main class="main-content position-relative max-height-vh-100 h-100 mt-1 border-radius-lg ">
    ...
    <br>
     <br>
     <button onclick="location.href='http://localhost/projet_web/web/back%20office/V/ajoutCategorie.php'">Add categories </button>
     <button onclick="location.href='http://localhost/projet_web/web/back%20office/V/rechercherListeCategorie.html'">Search categories</button>
     <button onclick="location.href='http://localhost/projet_web/web/back%20office/V/imprimerCategorie.php'">Print categories</button>
  ...
  <div class="search-container">
    <form action="recherchercategAVANCER.php">
