            ...
            <form method="post" action="#">
              <fieldset>
                <table class="data-table cart-table" id="shopping-cart-table">
                  <thead>
                    <tr class="first last">
                      <th rowspan="1"><span class="nobr">Num commande</span></th>
                      <th colspan="1" class="a-center"><span class="nobr">Date commande</span></th>
                      <th class="a-center " rowspan="1">Status</th>
                      <th colspan="1" class="a-center">Prix Total</th>
                      <th colspan="1" class="a-center">Type de paiment</th>
                      <th colspan="1" class="a-center">Type de Livraison</th>
                  ...
                  <?php 
                                ...
                                foreach ($c as $row)
                                {
                                    echo '  
                                    <tr class="first odd">
                                    <td><h2 class="product-name" > <a href="#" ">'.$row["num_commande"].'</a> </h2></td>
                                    <td class="a-center hidden-table" ><span class="product-name"> <span  ">'.$row["date_commande"].'</span> </span></td>
                                    <td class="a-center hidden-table" ><span class="product-name""> <span ">'.$row["status"].'</span> </span></td>
                                    <td class="a-center hidden-table" ><span class="product-name""> <span ">'.$row["prixTotal"].'</span> </span></td>
                                    <td class="a-center hidden-table" ><span class="product-name"> <span  ">'.$row["type_Paiment"].'</span> </span></td>
                                    <td class="a-center hidden-table" ><span class="product-name"> <span  ">'.$row["type_Livraison"].'</span> </span></td>
                                    <td>
                                    <a class="button " href="DetailCommandes.php?num_commande='.$row["num_commande"].'">View Details</a>
                                    <a class="button " href="PDF.php?num_commande='.$row["num_commande"].
                                    '&status='.$row["status"].'
                                    &prixTotal='.$row["prixTotal"].'
                                    &type_Paiment='.$row["type_Paiment"].'
                                    &type_Livraison='.$row["type_Livraison"].'">PDF</a>
                                    </td>
                                    </tr>
                                ';
                                }
