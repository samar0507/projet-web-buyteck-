...
<table border="1" align="center" id="box3">
<tr> 

  <th class="text-uppercase text-secondary text-xxs font-weight-bolder opacity-7 ps-10">Name Categorie </th>
...
foreach($Categorie1 as $row){ 
	?>
	<tr>
	<td class="ps-10"><?PHP echo $row['nom_cat']; ?></td>
	<?PHP
}
?>
<br><br>
...
<br><br>
<div align="center"><button onclick="location.href='http://localhost/projet_web/web/back%20office/V/categories.php'">Back </button></div>
<br><br>
