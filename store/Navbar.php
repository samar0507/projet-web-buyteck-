                                ...
                                <ul class="level0">
                                    <li class="level1 nav-6-1 parent item"><a href="#/mobiles.html"><span>Mobiles</span></a>
                                        <ul class="level1">
                                            ...
                                            <li class="level2 nav-6-1-1"><a href="#/mobiles/sony.html"><span>Oppo</span></a></li>
                                        </ul>
                                    </li>
...
?> <?php       
                                    ...
                                    ?>
                                    <li class="level1 nav-6-1 parent item"><a href="#/computer.html"><span><?php echo $row['nom_cat'];?> </span></a>
                                      <?PHP foreach($listeProduits as $row){ ?>  
                                    <ul class="level1">
                                            <li class="level2 nav-6-1-1"><a href="#/external-hard-disk.html"><span><?PHP echo $row['nom']; ?></span></a></li>
                                        </ul>
                                        <?PHP } ?>
                                    <?php }?>
                                </ul>
