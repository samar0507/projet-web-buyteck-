    ...
    <div class="row">
      <div class="col-xs-12">
        <ul class="breadcrumb">
          ...
          <li><a href="http://localhost/projet_web/web/back%20office/store/triNom.php">Sort by name</a></li>
      </div>
    </div>
  </div>
</div>
      ...
      <div class="col-left sidebar col-sm-10 col-xs-0 col-sm-pull-15">
        <aside class="col-left sidebar">
          <div class="side-nav-categories">
            <div class="block-title"> Sort by name </div>
            <!--block-title--> 
            <!-- BEGIN BOX-CATEGORY -->
...
<div align="center"><button class="bo" onclick="location.href='http://localhost/projet_web/web/back%20office/store/afficherProduits2.php'">Back  </button></div>
<br><br><br><br>
</div>
        </div> </div>
        <footer>
