...
if (isset($_GET['char'])) {
    ...
    $liste=$ProduitsCore->rechercherAVANCER($_GET['char']);
}
?>
...
<tr> 
           ...
           <th class="text-uppercase text-secondary text-xxs font-weight-bolder opacity-7 ps-4"> Name of product</th>
           ...
           <th class="text-uppercase text-secondary text-xxs font-weight-bolder opacity-7 ps-7">Picture</th>
</tr>
<?PHP
...
<div align="center"><button onclick="location.href='http://localhost/projet_web/web/back%20office/V/produits.php'">Back </button></div>
