...
if (isset($_POST["nom_cat"])) {
    if (!empty($_POST['nom_cat']))
    {
        ...
        $CategoriesCore->ajouterCategorie($categories);
        header('Location:categories.php');    
}
else $error="Missing Informations !!";
    }
?>
  ...
  <main class="main-content position-relative max-height-vh-100 h-100 mt-1 border-radius-lg ">
    ...
    <div class="container-fluid py-4">
     ...
     <div class="row">
          ...
          <div class="card mb-4">
            <div class="card-header pb-0">
              <div id="error">
               ...
               <h3 align="center" >Add categories</h3>
         <form action="" method="POST">
			<div class="wrap-table1000">
            <table border="1" align="center">
            <td align="center">Name of category :</td>
                <td><input type="text" name="nom_cat" id="nom_cat" maxlength="50" placeholder="the name is.." required></td></tr>
        ...
        <div align="center"><button onclick="location.href='http://localhost/projet_web/web/back%20office/V/categories.php'">Back to list categories </button></div>
        </br>
        </div>
        </div> 
